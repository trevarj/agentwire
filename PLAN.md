...
1. Validate codec, fragmentation, state replay, action deduplication, queue recovery, and the
   JSONL reference client locally.
2. Run interoperability tests against Ergo 2.19.0 with persistent SQLite history, 30-day
   retention, and Agentwire `TAGMSG` storage enabled.
